...
async function onResponse(context, url, request, response) {
  if (request.method == "GET") {
    response.body.routes[0] = shortRoute;
    response.body.routes[2] = longRoute;
  } else if (request.method == "POST") {
    response.body.routes[0] = longRoute;
    response.body.routes[1] = shortRoute;
    response.body.routes[0].summary.trafficDelayInSeconds = 1000;
  }
